...
db.getCollection('tags').insertMany([
  {
    name: 'fruit',
    image:
      'https://2.bp.blogspot.com/-he6irVNp93Q/V1r3YqdIkUI/AAAAAAAABlg/NDA_-UIGW8kU_iqYc3ugMGQ1OIIxYnsVQCLcB/s1600/blbtehfw-fotolia_30662478_s.jpg',
  },
  {
    name: 'dessert',
    image:
      'https://files.ferocecdn.com/wp-content/uploads/2019/04/2173d8cdca5d9a7dfd4bac3168c9ad3c-800x457.jpg',
  },
  {
    name: 'viande',
    image: 'image/default',
  },
  {
    name: 'fromage',
    image:
      'https://www.carrefour.fr/media/540x540/Photosite/PGC/P.L.S./3073781069716_PHOTOSITE_20211020_182335_0.jpg?placeholder=1',
  },
  {
    name: 'france',
    image: 'https://i.ytimg.com/vi/nu0VAeZJF54/maxresdefault.jpg',
  },
]);
...
db.getCollection('tags').insertMany([
  ...
  },
  {
    name: 'viande',
    image:
      'https://cdn.futura-sciences.com/buildsv6/images/wide1920/f/5/6/f56cb4cadf_50178034_chevre-pas-bete.jpg',
  },
  {
    name: 'fromage',
    image:
